    ...
    <div className="privacy-policy ">
      <div className="container">
        ...
        <section className="policy-section">
          ...
          <p>
            1.1 ООО «Антера КСБ» (далее по тексту – Оператор) ставит соблюдение
          ...
          <p>
            ...
            Оператор может получить о посетителях веб-сайта antera01.ru.
        ...
        <section className="policy-section">
          ...
          <p>
            ...
            в сети интернет по сетевому адресу antera01.ru;
          </p>
          <p>2.2 Пользователь – любой посетитель веб-сайта antera01.ru;</p>
          <p>
            2.3 Персональные данные – любая информация, относящаяся к
            Пользователю веб-сайта antera01.ru;
          </p>
          <p>
        ...
        <section className="policy-section">
          ...
          <p>
            ...
            antera01.ru. Отправляя свои персональные данные Оператору,
        ...
        <section className="policy-section">
          ...
          <p>
            ...
            к Оператору с помощью электронной почты info@antera01.ru.
          </p>
          <p>
