    ...
    <div className="about сontainer">
      <div className="section__missia">
        <div className="missia__left">
          ...
          <p className="missia__left__text">
            Наша миссия — внедрять передовые технологии для роста бизнесса наших
            клиентов. Делая сложное простым. Мы верим, что цифровые решения
            должны быть поняными, надежными и полезными каждому пользователю.
          </p>
        </div>
      ...
      <div className="section__cennosti">
        ...
        <div className="comanda">
          <h3>Наша команда</h3>
          <p>
            Сегодня команда CodexTech — это разработчики, дизайнеры и проектные
            менеджеры, объединённые одной целью: создавать IT-продукты, которые
            приносят реальную пользу бизнесу. Мы небольшие, но гибкие, быстро
            адаптируемся к новым задачам и ценим командную работу.
          </p>
        </div>
        <div className="plusi">
          ...
          <div className="doverie__container">
            ...
            <div className="doverie__right">
              <p>
                ...
                местоположение предметов, а также выявлять недостающие объекты.
              </p>
            </div>
          </div>
        </div>
